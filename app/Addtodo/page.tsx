...
const Addtodo = () => {
  ...
  const handleAddtodo = async () => {
    try {
      ...
      console.log("Added todo successfully", response.data);
      router.push("/");
    } catch (error: any) {
      console.log("Todo is not added", error.message);
  ...
  return (
    <div className="w-full bg-[#f4f4f4] box-border mx-auto border-transparent">
      ...
      <button
        className="bg-navy-400 box-border p-2 text-xl mt-5 w-100 flex mx-auto justify-center rounded-lg "
